...
const Tailormade = ({ data = {} }) => {
  ...
  const onSubmit = (data, e) => {
    ...
    fetch('/api/klaviyo/tailormade-join', {
      method: 'POST',
      ...
      <AnimatePresence exitBeforeEnter>
        {!error && !success && (
          ...
          >
            ...
            <input type="text" name="fname" id="fname" inputMode="text" />
            <label htmlFor="lname">achternaam</label>
            <input type="text" name="lname" id="lname" inputMode="text" />
